  ...
  return (
    <div className="bg-gray-900 rounded-lg p-8">
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <span className="text-blue-400">support@theskillvendor.com</span>
      </div>
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <span className="text-blue-400">+91-7977948089</span>
      </div>
      ...
      <div className="flex gap-4 mb-8">
        ...
        {/* X (Twitter) */}
        <div className="w-10 h-10 bg-black border border-gray-600 rounded-full flex items-center justify-center hover:bg-gray-800 transition-colors cursor-pointer">
          <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="flex items-start gap-3">
        ...
        <span className="text-white">
          Cyber Park, Basni Industrial Area, Jodhpur, Rajasthan.
        </span>
      </div>
    </div>
  );
